...
namespace Modules.Rendering.Outline
{
    ...
    public class OutlinePass: CustomPass
    {
        ...
        protected override void Setup(ScriptableRenderContext RenderContext, CommandBuffer CMD)
        {
            ...
            OutlineDepthBuffer = RTHandles.Alloc
            (
                Vector2.one, TextureXR.slices, dimension: TextureXR.dimension,
                depthBufferBits: DepthBits.Depth24,
                useDynamicScale: true, name: "Outline Depth Buffer"
            );
        }

        protected override void Execute(CustomPassContext CTX)
        {
            CoreUtils.SetRenderTarget(CTX.cmd, OutlineBuffer, OutlineDepthBuffer, ClearFlag.All);
            ...
            CTX.propertyBlock.SetTexture("OutlineDepthBuffer", OutlineDepthBuffer);
